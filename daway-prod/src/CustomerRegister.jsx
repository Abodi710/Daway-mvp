 ...
 * (الخادم يستبدله بـ 'عميل' إن كان فارغاً)، و`role: 'customer'` هو دور قاعدة
 * البيانات مباشرةً — لا يمرّ بمحوّل الأدوار لأنه مكتوب بصيغته الخلفية أصلاً.
 * `phone` عمود حقيقي يقرأه المسار ويخزّنه.
 *
